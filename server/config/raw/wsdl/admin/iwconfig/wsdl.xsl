<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="/">
		<definitions targetNamespace="urn:schemas-iwaysoftware-com:jul2003:ibse:config" xmlns:tns="urn:schemas-iwaysoftware-com:jul2003:ibse:config" xmlns:soap="http://schemas.xmlsoap.org/wsdl/soap/" xmlns:soapenc="http://schemas.xmlsoap.org/soap/encoding/" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:tm="http://microsoft.com/wsdl/mime/textMatching/" xmlns:mime="http://schemas.xmlsoap.org/wsdl/mime/" xmlns="http://schemas.xmlsoap.org/wsdl/">
			<types>
				<xs:schema xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:tns="urn:schemas-iwaysoftware-com:jul2003:ibse:config" targetNamespace="urn:schemas-iwaysoftware-com:jul2003:ibse:config" elementFormDefault="qualified">
					<xsl:for-each select="iWayBusinessService/operations/method">
						...
						<xsl:copy-of select="input/xs:schema/xs:group"/>
						...
						<xsl:copy-of select="output/xs:schema/xs:group"/>
					</xsl:for-each>
